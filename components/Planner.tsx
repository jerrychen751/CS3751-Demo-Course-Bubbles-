...
import { Search, Trash2, AlertTriangle, CheckCircle2, ArrowLeft, Info, MoveHorizontal } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-[#0f172a] text-white font-sans">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        >
          ...
          >
            {/* SVG Layer - Now inside the scaled container so lines scroll with content */}
